...
npm start
`
//Coding styles we intend to follow.
...
16. We plan to avoid long lines of code.
17.Use verbs for function names and nouns for classes and attributes
18.Perform testing on components.
19.Account for eror handling.
